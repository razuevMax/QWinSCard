...
public:
 ...
 static const QString ALL_READERS;//!< Default winscard name for all readers group
 static const QString DEFAULT_READERS;//!< Default winscard name for default readers group
 static const QString LOCAL_READERS;//!< Default winscard name for local readers group
 static const QString SYSTEM_READERS;//!< Default winscard name for system readers group
 ...
 //! \fn QUuid WinSCard::GetProviderId(const QString& cardName)
 ...
 //! \fn QStringList WinSCard::ListCards(const QByteArray& cardAtr, const QVector<QUuid>& guidInterfaces)
 ...
 //! \fn QStringList WinSCard::ListCards(const QVector<QUuid>& guidInterfaces)
 ...
 //! \fn QStringList WinSCard::ListCards(const QByteArray& cardAtr)
 ...
 //! \fn QStringList WinSCard::ListCards(void)
 ...
 //! \fn QVector<QUuid> WinSCard::ListInterfaces(const QString& cardName)
 ...
 //! @{
 //! \fn void WinSCard::AddReaderToGroup(const QString& ReaderName, const QString& GroupName)
 ...
 //! \fn void WinSCard::ForgetReaderGroup(const QString& GroupName)
 ...
 //! \fn void WinSCard::IntroduceReader(const QString& ReaderName, const QString& DeviceName)
 ...
 //! \fn void WinSCard::IntroduceReaderGroup(const QString& GroupName)
 ...
 //! \fn void WinSCard::RemoveReaderFromGroup(const QString& ReaderName, const QString& GroupName)
 ...
 //! \fn void WinSCard::IntroduceCardType(const QString& cardName, const QVector<QUuid>& guidInterfaces, const QByteArray& cardAtr, const QByteArray& cardAtrMask, QUuid *pguidPrimaryProvider)
 ...
 //! \fn void WinSCard::IntroduceCardType(const QString& cardName, const QVector<QUuid>& guidInterfaces, const QByteArray& cardAtr, QUuid *pguidPrimaryProvider)
 ...
 //! \fn void WinSCard::IntroduceCardType(const QString& cardName, const QByteArray& cardAtr, const QByteArray& cardAtrMask, QUuid *pguidPrimaryProvider)
 ...
 //! \fn void WinSCard::IntroduceCardType(const QString& cardName, const QByteArray& cardAtr, QUuid *pguidPrimaryProvider)
 ...
 //! \fn void WinSCard::LocateCards(const QStringList& cards, ReadersStates& readerStates)
 ...
 //! \fn void WinSCard::LocateCardsByATR(const QVector<QPair<QByteArray, QByteArray>>& atrMask, ReadersStates& readerStates)
